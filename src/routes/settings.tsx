...
function SettingsPage() {
  ...
  const allItems: Array<{
    ...
    { label: "Catálogo Público", description: "Link público do catálogo (preço de varejo + previsão). Compartilhe a URL — não exige login.", to: "/catalog", icon: Package, external: true },
